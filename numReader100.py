...
def testar_mnist_test(index):
    ...
    for i in range(hidden[0].size):
        hidden[0][i]*=255.0    
    hidden_img = Image.fromarray(hidden[0].reshape(10,10)) 
    base = 150
